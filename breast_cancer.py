...
Original file is located at
    https://colab.research.google.com/drive/1OdOVjlVM1mz3PJdT8PGt6RzUcZ_VxS1E
"""
...
#the data into independent 'X' and dependent 'Y' variables
X = df.iloc[:, 2:32].values #Notice I started from index  2 to 31, essentially removing the id column & diagnosis
Y = df.iloc[:, 1].values #Get the target variable 'diagnosis' located at index=1

#the dataset into 75% Training set and 25% Testing set
...
pickle.dump(model[2],open('breastcancer_model.pkl','wb'))
model_cancer = pickle.load(open('breastcancer_model.pkl','rb'))

model_cancer.predict(X_test)
