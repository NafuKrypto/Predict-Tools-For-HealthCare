# -*- coding: utf-8 -*-
"""
Created on Thu Jun 25 04:38:36 2020
...
url = 'http://localhost:5000/results_bc'
r = requests_bc.post(url,json={[ 'radius_mean':12.46 ,	'texture_mean':	24.04,'perimeter_mean':83.97,	'area_mean':475.9,	
